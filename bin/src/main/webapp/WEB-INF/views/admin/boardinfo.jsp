        ...
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav slimscrollsidebar">
                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        <a href="#" class="waves-effect" style="background-color: black; color: white;" ><i class="fa fa-table fa-fw" aria-hidden="true"></i>사용자 통계</a>
                    </li>
                </ul>
            </div>
        </div>
                            ...
                            <h3 class="box-title" style="color: red;">게시판 관리</h3>
                              ...
                              <form name="move" method="get">
		                         <select name=url onchange="moveurl(this.value)">
		                        	...
		                        	<option value="${root}/admin/boardinfo.do">캠핑후기</option>
		                        	<option value="#">캠핑문의</option>
		                     	</select>
		                      </form>
