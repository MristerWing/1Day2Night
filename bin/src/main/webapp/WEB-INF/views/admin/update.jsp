		   ...
		   <div>
			<input type="hidden" name="user_num" value="${adminDto.user_num}">
 				<table border="1">
					<tr>
					   <td>user_num</td>
					   <td><input type="text" size="30"  value="${adminDto.user_num}"></td>
				  </tr>
				  <tr>
					   <td>nickname</td>
					   <td><input type="text" size="30" value="${adminDto.nickname}"></td>
				  </tr>
				  <tr>
					   <td>user_name</td>
					   <td><input type="password" size="30" value="${adminDto.user_name}"></td>
				  </tr>
				  <tr>
					   <td>email</td>
					   <td><input type="text" size="30"  value="${adminDto.email}"></td>
				  </tr>
				  <tr>
					   <td>register_type</td>
					   <td><input type="text" size="30" value="${adminDto.register_type}"></td>
				  </tr>
				   <tr>
					   <td>register_data</td>
					   <td><input type="text" size="30"  value="${adminDto.register_date}"></td>
				  </tr>
 				</table>
