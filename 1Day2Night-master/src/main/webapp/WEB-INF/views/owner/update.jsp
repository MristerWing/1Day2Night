					...
					<form class="register_form" action="${root}/owner/ownerUpdate.do" id="inputForm" method="POST"
						...
						<div class="form-group">
							<label for="pwd">부제목</label> <input type="text"
								class="form-control" value="${camp.title}" name="title">
						</div>
						...
						<script type="text/javascript">
							...
							makeCheckBoxs(tags, '${camp.tag}', 'tag');
						...
						<div class="form-group">
							<label>홈페이지 주소</label> <input type="text" class="form-control"
								id="camp_link" name="camp_link" value="${camp.camp_link}">
						</div>
						<div class="form-group">
							<label>입지 선택(*)</label>
							<div id="loc"></div>
						...
						<script type="text/javascript">
							...
							makeCheckBoxs(locs, '${camp.location_type}', 'loc');
						...
						<script type="text/javascript">
							...
							makeCheckBoxs(opers, '${camp.operation_type}', 'oper');
						</script>
						<div class="form-group">
							<label>캠핑장유형</label>
							<div id="campType"></div>
						...
						<div class="form-group">
							...
							<input type="text" class="form-control"
								id="etc_facilities" name="etc_facilities" value="${camp.etc_facilities}"> 
							
							<label for="bottom_type">바닥형태</label>
							<input type="text" class="form-control"
								id="bottom_type" name="bottom_type" value="${camp.bottom_type}">
						...
						<script type="text/javascript">
							var animal = '${camp.animal_access}';
							$("input[name = animal_access]").each(function () {
								if($(this).val() == animal){
						...
						<script type="text/javascript">
							var torch = '${camp.torch}';
							$("input[name = torch]").each(function () {
								if($(this).val() == torch){
									$(this).attr("checked", "checked");
								}
							});
						...
						<div class="form-group">
							<label for="pwd">글램핑 시설</label> <input type="text"
								class="form-control" value="${camp.gramping_facilities}" name="gramping_facilities">
						</div>
						<div class="form-group">
							<label for="pwd">카라반 시설</label> <input type="text"
								class="form-control" value="${camp.karaban_facilities}" name="karaban_facilities">
						</div>
