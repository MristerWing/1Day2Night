	...
	<script type="text/javascript">
	 ...
	 <script type="text/javascript">
		...
		// 만들 팝업창 상하 크기의 1/2 만큼 보정값으로 빼주었음
  			...
  			function deleteOk(root,review_num) {
				var url = root + "/admin/reviewDelete.do?review_num="+review_num;
				//alert(url);
...
<table id="example" class="display" style="width:100%">
        ...
        <tbody>
           <c:forEach var="i" items="${boardReviewList}">
           		 <tr>
                    <td>${i.review_num}</td>
                    <td>${i.user_num}</td>
                    <td>${i.write_date}</td>
                    ...
                    <td>${i.title}</td>
           			...
           			<td><input type="button" class="btn btn-danger" value="삭제" onclick="deleteOk('${root}','${i.review_num}')"></td>
                 </tr>
