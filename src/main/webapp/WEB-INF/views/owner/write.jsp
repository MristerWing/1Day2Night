	...
	<section class="about py-lg-5 py-md-5 py-5">
		<div class="container">
			<div class="inner-sec-w3pvt py-lg-5 py-3">
				<h3 class="tittle text-center mb-lg-5 mb-3 px-lg-5">사업자 정보입력</h3>
				<div class="register_content">
					<form class="register_form" id="inputForm" action="" method="POST"
						...
						<div class="form-group">
							<label>서브 이미지를 선택해주세요(최대3개)</label> <input type="file"
								class="form-control-file border" name="sub-image">
						</div>
						<div class="form-group">
						...
						<script type="text/javascript">
							...
							makeCheckBoxs(campType, '', 'camp-type');
						</script>
						<div class="form-group">
							<label>운영기간</label>
						...
						<script type="text/javascript">
							...
							makeCheckBoxs(opPeriod, '', 'op-period');
						</script>
						<div class="form-group">
							<label>영업 날짜</label>
							<div id="op-day"></div>
						...
						<script type="text/javascript">
							var opDays = ["평일", "주말"];
							makeCheckBoxs(opDays, '', 'op-day');
						</script>
						<div class="form-group">
							<label>시설정보</label>
							<div id="main-facilities"></div>
							<input type="hidden" name="main_facilities">
						</div>
						<script type="text/javascript">
							var main_facilities = ["전기", "무선인터넷", "장작판매", "온수", "트렘폴린", "물놀이장", "놀이터", "산책로", "운동장", "운동시설", "마트.편의점"];
							makeCheckBoxs(main_facilities, '', 'main-facilities');
						</script>
						...
						<div class="form-group" style="width: 100%; overflow: hidden;">
							...
							<input type="hidden" name="site_size" >
						</div>
						<div class="form-group">
