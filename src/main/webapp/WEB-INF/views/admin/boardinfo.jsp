        ...
        <nav class="navbar navbar-default navbar-static-top m-b-0">
            <div class="navbar-header">
                <div class="top-left-part">
                    <!-- Logo -->
                    <a class="logo" href="${root}/index.jsp">
                            ...
                            <h3 class="box-title" style="color: red;">게시판 관리</h3>
                              ...
                              <form name="move" method="get">
		                         <select name=url onchange="moveurl(this.value)">
		                        	<option value="${root}/admin/boardList.do" selected="selected">캠핑소식</option>
		                        	<option value="${root}/admin/boardreview.do">캠핑후기</option>
		                        	<option value="${root}/admin/boardQnA.do">캠핑문의</option>
		                     	</select>
		                     	<input type="button" style="margin-left: 20px;" class="btn btn-danger" value="공지글 작성" onclick="location.href='${root}/board/campInfo/write.do?user_num=${user_num}'">
		                      </form>
     							<jsp:include page="./boardinfotable.jsp" flush="true">
