...
<%-- 	<div align="center" style="margin: 100px auto;">
	<form class="form" action="${root}/admin/deleteOk.do" method=post>
	 ...
	 --%>
	 <div align="center" style="margin: 100px auto;">
		<form class="form" action="${root}/admin/QnAdeleteOk.do" method=post>
		   <div>
			<input type="hidden" name="qna_num" value="${campQnADto.qna_num}">
 				<table border="1">
					<tr>
					   <td>USER_NUM</td>
					   <td><input type="text" size="53"  value="${campQnADto.user_num}" disabled="disabled"></td>
				  </tr>
				  <tr>
					   <td>QNA_NUM</td>
					   <td><input type="text" size="53" value="${campQnADto.qna_num}" disabled="disabled"></td>
				  </tr>
				  <tr>
					   <td>WRITE_DATE</td>
					   <td><input type="text" size="53" value="${campQnADto.write_date}" disabled="disabled"></td>
				  </tr>
				  <tr>
					   <td>QNA_TYPE</td>
					   <td><input type="text" size="53"  value="${campQnADto.qna_type}" disabled="disabled"></td>
				  </tr>
				  <tr>
					   <td>TITLE</td>
					   <td><input type="text" size="53" value="${campQnADto.title}" disabled="disabled"></td>
				  </tr>
				   <tr>
					   <td>CONTENT</td>
					   <td><c:out value="${campQnADto.content}" escapeXml="false"></c:out></td>
				  </tr>
