                ...
                <div class="container">
                    ...
                    <div id="layout-1" style="display: block;">
                        <div class="top_search_box">
                            <form id="campSearchForm2" action="#none" method="get">
                                <input type="hidden" name="listTy" value="MAP" />
                                <input
                                    id="listOrdrTrget"
                                    name="listOrdrTrget"
                                    type="hidden"
                                ...
                                <div>
                                    ...
                                    <div class="form_w form_w_movV">
                                        <ul>
                                            ...
                                            <li class="tt">
                                                <strong class="title">테마</strong>
                                                <div class="select_box them">
                                                    <label for="searchLctCl"
                                                        >전체</label
                                                    >
                                                    <select
                                                        class="detail_select"
                            ...
                            <div class="detail_search_w">
                                <ul>
                                                    ...
                                                    <ul>
                                                        <li>
                                                            <input
                                                                type="checkbox"
                                                                class="check01"
                                                                name="searchSiteBottomCl1"
                                                                id="searchSiteBottomCl1"
                                                                value="잔디"
                                                            /><label
                                                                for="searchSiteBottomCl1"
                                                                class="label_name"
                                                                >잔디</label
                                                            >
                                                        </li>
                                                        ...
                                                        <li>
                                                            <input
                                                                type="checkbox"
                                                                class="check01"
                                                                name="searchSiteBottomCl3"
                                                                id="searchSiteBottomCl3"
                                                                value="파쇄석"
                                                            /><label
                                                                for="searchSiteBottomCl3"
                                                                class="label_name"
                                                                >파쇄석</label
                                                            >
                                                        </li>
                                                        <li>
                                                            <input
                                                                type="checkbox"
                                                                class="check01"
                                                                name="searchSiteBottomCl4"
                                                                id="searchSiteBottomCl4"
                                                                value="자갈"
                                                            /><label
                                                                for="searchSiteBottomCl4"
                                                                class="label_name"
                                                                >자갈</label
                                                            >
                                                        </li>
                                                        <li>
                                                            <input
                                                                type="checkbox"
                                                                class="check01"
                                                                name="searchSiteBottomCl5"
                                                                id="searchSiteBottomCl5"
                                                                value="맨흙"
                                                            /><label
                                                                for="searchSiteBottomCl5"
                                                                class="label_name"
                                                                >맨흙</label
                                                            >
                                                        </li>
                                                    ...
                                                    <ul>
                                                        <li>
                                                            <input
                                                                ...
                                                                id="searchSbrsClCode01"
                                                                value="전기"
                                                                class="check01"
                                                            /><label
                                                                for="searchSbrsClCode01"
                                                                >전기</label
                                                            >
                                                        </li>
                                                        <li>
                                                        ...
                                                        <li>
                                                            <input
                                                                type="checkbox"
                                                                name="searchSbrsClCode"
                                                                id="searchSbrsClCode03"
                                                                value="장작판매"
                                                                class="check01"
                                                            /><label
                                                                for="searchSbrsClCode03"
                                                                >장작판매</label
                                                            >
                                                        </li>
                                                        <li>
                                                            <input
                                                                type="checkbox"
                                                                name="searchSbrsClCode"
                                                                id="searchSbrsClCode04"
                                                                value="온수"
                                                                class="check01"
                                                            /><label
                                                                for="searchSbrsClCode04"
                                                                >온수</label
                                                            >
                                                        </li>
                                                        <li>
                                                            <input
                                                                type="checkbox"
                                                                name="searchSbrsClCode"
                                                                id="searchSbrsClCode05"
                                                                value="트렘폴린"
                                                                class="check01"
                                                            /><label
                                                                for="searchSbrsClCode05"
                                                                >트렘폴린</label
                                                            >
                                                        </li>
                                                        <li>
                                                            <input
                                                                type="checkbox"
                                                                name="searchSbrsClCode"
                                                                id="searchSbrsClCode06"
                                                                value="물놀이장"
                                                                class="check01"
                                                            /><label
                                                                for="searchSbrsClCode06"
                                                                >물놀이장</label
                                                            >
                                                        </li>
                                                        <li>
                                                            <input
                                                                type="checkbox"
                                                                name="searchSbrsClCode"
                                                                id="searchSbrsClCode07"
                                                                value="놀이터"
                                                                class="check01"
                                                            /><label
                                                                for="searchSbrsClCode07"
                                                                >놀이터</label
                                                            >
                                                        </li>
                                                        <li>
                                                            <input
                                                                type="checkbox"
                                                                name="searchSbrsClCode"
                                                                id="searchSbrsClCode08"
                                                                value="산책로"
                                                                class="check01"
                                                            /><label
                                                                for="searchSbrsClCode08"
                                                                >산책로</label
                                                            >
                                                        </li>
                                                        <li>
                                                            <input
                                                                type="checkbox"
                                                                name="searchSbrsClCode"
                                                                id="searchSbrsClCode09"
                                                                value="운동장"
                                                                class="check01"
                                                            /><label
                                                                for="searchSbrsClCode09"
                                                                >운동장</label
                                                            >
                                                        </li>
                                                        <li>
                                                            <input
                                                                type="checkbox"
                                                                name="searchSbrsClCode"
                                                                id="searchSbrsClCode010"
                                                                value="운동시설"
                                                                class="check01"
                                                            /><label
                                                                for="searchSbrsClCode010"
                                                                >운동시설</label
                                                            >
                                                        </li>
                                                        <li>
                                                            <input
                                                                type="checkbox"
                                                                name="searchSbrsClCode"
                                                                id="searchSbrsClCode011"
                                                                value="마트.편의점"
                                                                class="check01"
                                                            /><label
                                                                for="searchSbrsClCode011"
                                                                >마트.편의점</label
                                                            >
                                                        </li>
                                                    </ul>
                                    ...
                                    <li class="detail_btn_w">
                                        ...
                                        <button type="button" class="serach button">
                                            검색
                                        </button>
                    ...
                    <div id="layout-3" style="display: none;">
                        ...
                        <div class="tagBtn_group">
                            <ul>
                                <li class="tag_s">
                                    <a href="#none" class="animal tagBtn" id="animal"
                                        >#애견동반</a
                                    >
                                </li>
                                <li>
                                    <a href="#none" class="tagBtn " id="110_111"
                                        >#계곡옆</a
                                    >
                                </li>
                                <li>
                                    <a href="#none" class="tagBtn " id="104_109"
                                        >#아이들 놀기 좋은</a
                                    >
                                </li>
                                <li>
                                    <a href="#none" class="tagBtn " id="104_107"
                                        >#차대기 편한</a
                                    >
                                </li>
                                <li>
                                    <a href="#none" class="tagBtn " id="123_124"
                                        >#힐링</a
                                    >
                                </li>
                                <li>
                                    <a href="#none" class="tagBtn " id="126_155"
                                        >#익스트림</a
                                    >
                                </li>
                                <li>
                                    <a href="#none" class="tagBtn " id="104_105"
                                        >#깨끗한</a
                                    >
                                </li>
                                <li>
                                    <a href="#none" class="tagBtn " id="110_115"
                                        >#바다가 보이는</a
                                    >
                                </li>
                                <li>
                                    <a href="#none" class="tagBtn " id="98_129"
                                        >#가을</a
                                    >
                                </li>
                                <li>
                                    <a href="#none" class="tagBtn " id="126_157"
                                        >#야영장사고배상책임보험가입</a
                                    >
                                </li>
                                <li>
                                    <a href="#none" class="tagBtn " id="117_121"
                                        >#자전거 타기 좋은</a
                                    >
                                </li>
                                <li>
                                    <a href="#none" class="tagBtn " id="99_102"
                                        >#여유있는</a
                                    >
                                </li>
                                <li>
                                    <a href="#none" class="tagBtn " id="98_130"
                                        >#겨울</a
                                    >
                                </li>
                                <li>
                                    <a href="#none" class="tagBtn " id="123_125"
                                        >#커플</a
                                    >
                                </li>
                                <li>
                                    <a href="#none" class="tagBtn " id="110_114"
                                        >#물맑은</a
                                    >
                                </li>
                                <li>
                                    <a href="#none" class="tagBtn " id="104_108"
                                        >#수영장 있는</a
                                    >
                                </li>
                                <li>
                                    <a href="#none" class="tagBtn " id="99_101"
                                        >#재미있는</a
                                    >
                                </li>
                                <li>
                                    <a href="#none" class="tagBtn " id="117_119"
                                        >#축제</a
                                    >
                                </li>
                                <li>
                                    <a href="#none" class="tagBtn " id="117_120"
                                        >#둘레길</a
                                    >
                                </li>
                                <li>
                                    <a href="#none" class="tagBtn " id="98_128"
                                        >#여름</a
                                    >
                                </li>
                                <li>
                                    <a href="#none" class="tagBtn " id="123_146"
                                        >#가족</a
                                    >
                                </li>
                                <li>
                                    <a href="#none" class="tagBtn " id="99_103"
                                        >#사이트 간격이 넓은</a
                                    >
                                </li>
                                <li>
                                    <a href="#none" class="tagBtn " id="117_118"
                                        >#문화유적</a
                                    >
                                </li>
                                <li>
                                    <a href="#none" class="tagBtn " id="110_116"
                                        >#그늘이 많은</a
                                    >
                                </li>
                                <li>
                                    <a href="#none" class="tagBtn " id="98_127"
                                        >#봄</a
                                    >
                                </li>
                                <li>
                                    <a href="#none" class="tagBtn " id="104_106"
                                        >#온수 잘 나오는</a
                                    >
                                </li>
                                <li>
                                    <a href="#none" class="tagBtn " id="110_112"
                                        >#생태교육</a
                                    >
                                </li>
                                <li>
                                    <a href="#none" class="tagBtn " id="117_122"
                                        >#별 보기 좋은</a
                                    >
                                </li>
                                <li>
                                    <a href="#none" class="tagBtn " id="99_100"
                                        >#친절한</a
                                    >
                                </li>
                                <li>
                                    <a href="#none" class="tagBtn " id="110_113"
                                        >#물놀이 하기 좋은</a
                                    >
                                </li>
                            </ul>
                        ...
                        <div class="tagSearch_btn_wrap">
                            ...
                            <a href="#" class="btn_search" id="btn_tag_search">
                                검색하기</a
                            >
                            <script type="text/javascript">
