 ...
 * @date 2019. 12. 23.
 * @description 확정 아님
 *  DB에 PW를 저장할 때 솔트 쳐서 SHA-256방식으로 암호화 하는 방법 시도 중
 */
public class MemberDto {
	...
	private String salt; //패스워드 해시값 방어용
...
//	private int age;
	...
	public MemberDto(int user_num, Date register_date, String email, String email_auth_key, String password,
			String salt, String register_type, Integer user_auth_id, String email_auth_status, Integer phone_num,
	...
	public String toString() {
		return "MemberDto [user_num=" + user_num + ", register_date=" + register_date + ", email=" + email
				+ ", email_auth_key=" + email_auth_key + ", password=" + password + ", salt=" + salt
				+ ", register_type=" + register_type + ", user_auth_id=" + user_auth_id + ", email_auth_status="
				+ email_auth_status + ", phone_num=" + phone_num + ", interest=" + interest + ", user_name=" + user_name
